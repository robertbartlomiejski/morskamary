...
_MARINE_KEYWORDS = {
    "ecosystem", "biodiversity", "marine biology", "fisheries", "aquaculture",
    "biophysical", "species", "habitat", "ecological", "ocean ecology",
    "marine life", "reef", "wetland",
}

_OCEANIC_KEYWORDS = {
    "governance", "policy", "international", "transboundary", "planetary",
    "ocean pact", "sovereignty", "hydrosocial", "ocean literacy",
    "sustainability framework", "climate change", "multilevel", "global",
}

_MARITIME_KEYWORDS = {
    "port", "shipping", "transport", "infrastructure", "digital", "technology",
    "labor", "labour", "workforce", "economy", "industry", "trade", "logistics",
}
