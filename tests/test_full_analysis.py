...
BASELINE_CSV = DATA_DERIVED / "Blue Social Competences Univ Szczecin - Overall Blue Competences Dimension.csv"
...
from src.gap_analyzer import (
    ...
    SECTOR_TO_CSV_COL,
    analyze_gap,
    analyze_gaps_all_sectors,
    generate_gap_report,
    get_sector_required_competence_ids,
    load_sector_matrix,
)
from src.credential_designer import (
    assign_eqf_level,
    calculate_ects,
    calculate_pathways,
    define_assessment,
    design_bridge_credential,
    design_credentials_all_sectors,
...
class TestCredentialDesigner:
    ...
    def test_calculate_ects_advanced_bonus(self):
        ...
        comps = [
            _make_competence(f"id{i}", level=CompetenceLevel.ADVANCED)
            for i in range(5)
        ]
...
class TestReportGenerator:
    ...
    def test_html_index_valid_structure(self, tmp_path):
        ...
        gap = {"Blue Biotech": {"required": ["x"], "available": ["x"], "missing": [], "gap_pct": 0.0, "axis_breakdown": {}}}
    ...
    def test_gaps_html_color_coding(self, tmp_path):
        ...
        gap = {
            "Blue Biotech": {"required": ["a"], "available": ["a"], "missing": [], "gap_pct": 0.0, "axis_breakdown": {}},
            "Coastal Tourism": {"required": ["a", "b", "c"], "available": ["a"], "missing": ["b", "c"], "gap_pct": 66.7, "axis_breakdown": {}},
        }
    ...
    def test_csv_exports_columns(self, tmp_path):
        ...
        expected = {"sector", "required", "available", "missing", "gap_pct", "dominant_axis"}
