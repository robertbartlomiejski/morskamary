...
WORKFLOW_TEXT = (Path(__file__).resolve().parents[1] / ".github" / "workflows" / "full-live-analysis.yml").read_text(
    encoding="utf-8"
)
...
def test_schedule_commit_gate_uses_explicit_repo_variable_not_dispatch_input() -> None:
    ...
    trailing = WORKFLOW_TEXT[schedule_line_index : schedule_line_index + 180]
