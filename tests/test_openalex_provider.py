...
class TestOpenAlexRawPayloadAbstractStripping:
    """PR review fix: raw_payload must never retain abstract_inverted_index."""
    ...
    def test_search_raw_payload_strips_abstract_inverted_index(self) -> None:
        ...
        # Non-abstract fields must survive the cleanup untouched.
    ...
    def test_verify_doi_raw_payload_strips_abstract_inverted_index(self) -> None:
        ...
        work = {
            ...
            "topics": [],
            "keywords": [],
            "abstract_inverted_index": {"the": [0, 5], "ocean": [1]},
        }
